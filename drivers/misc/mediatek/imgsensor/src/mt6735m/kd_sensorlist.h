...
UINT32 OV5695_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); /* jianwei.luo front sensor ov5695 sensorinit function **/
...
UINT32 S5K3H7YX_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);/* jianwei.luo back sensor s5k3h7yx sensorinit function **/
UINT32 S5K3L8_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); /* jianwei.luo back sensor s5k3l8 sensorinit function **/
UINT32 S5K3L8B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); /* jianwei.luo back sensor s5k3l8b sensorinit function **/
...
#endif /* jianwei.luo back sensor s5k3l8 in list 1 **/
#if defined(S5K3L8B_MIPI_RAW)
   {S5K3L8B_SENSOR_ID, SENSOR_DRVNAME_S5K3L8B_MIPI_RAW, S5K3L8B_MIPI_RAW_SensorInit},
#endif /* jianwei.luo back sensor s5k3l8 in list 2 **/
#if defined(S5K3H7YX_MIPI_RAW)
   {S5K3H7YX_SENSOR_ID, SENSOR_DRVNAME_S5K3H7YX_MIPI_RAW, S5K3H7YX_MIPI_RAW_SensorInit},
#endif /* jianwei.luo back sensor s5k3h7yx in list 3 **/
...
#endif /* jianwei.luo front sensor ov5695 in list 4 **/
