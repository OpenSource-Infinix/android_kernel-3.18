...
#include "s5k3l8bmipiraw_Sensor.h"
...
#define SHUTTER_0_8S 78010
#define SHUTTER_1S 97513
#define SHUTTER_1_5S 146270
#define SHUTTER_2S 195026
#define SHUTTER_2_5S 243783
#define SHUTTER_3_2S 312042
#define SHUTTER_4S 390053
#define SHUTTER_5S 487567
#define SHUTTER_6S 585080
...
/****************************   Modify end    *******************************************/
//extern  bool s5k3l8_selective_read_byte(unsigned short addr,unsigned char *data,u16 i2c_id );
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = 0x30C8,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
bool s5k3l8b_selective_read_byte(unsigned short addr,unsigned char *data,u16 i2c_id )
{
	char puSendCmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF) };
	kdSetI2CSpeed(imgsensor_info.i2c_speed); 
	if (iReadRegI2C(puSendCmd , 2, data, 1, i2c_id) < 0) {
		//CAM_CALERR("[CAM_CAL][] fail s5k3l8_byteread_cmos_sensor addr =0x%x, data = 0x%x\n", addr, *data);
		return -1;
	}
	return 1;
...
//	kal_uint32 frame_length = 0;
	...
	switch(shutter_choose)
		...
		case SHUTTER_1S: //97513
		write_cmos_sensor(0x0342, 0x3F86);
		write_cmos_sensor(0x0340, 0x1b41);
		write_cmos_sensor(0x0202, 0x1b31); 
		break;
		case SHUTTER_1_5S: //146270
		write_cmos_sensor(0x0342, 0x3F86);
		write_cmos_sensor(0x0340, 0x28d9);
		write_cmos_sensor(0x0202, 0x28c9); 
		break;
		case SHUTTER_2S:// 195026
		write_cmos_sensor(0x0342, 0x3F86);
		write_cmos_sensor(0x0340, 0x3671);
		write_cmos_sensor(0x0202, 0x3661); 
		break;
		case SHUTTER_2_5S: //243783
		write_cmos_sensor(0x0342, 0x3F86);
		write_cmos_sensor(0x0340, 0x440a);
		write_cmos_sensor(0x0202, 0x43fa); 
		break;
		case SHUTTER_3_2S: //390053
		write_cmos_sensor(0x0342, 0x3F86);
		write_cmos_sensor(0x0340, 0x6cd3);
		write_cmos_sensor(0x0202, 0x6cc3); 
		break;
	 case SHUTTER_4S:// 4s
	 		LOG_INF("xxxx-------shutter1_2 \n ");
			write_cmos_sensor(0x0342, 0x3F86);
	 ...
	 case SHUTTER_5S: //5s
			...
			write_cmos_sensor(0x0342, 0x3F86);
			write_cmos_sensor(0x0340, 0xa335);
			write_cmos_sensor(0x0202, 0xa325); 
  			break;
	case SHUTTER_6S: //5s
			printk("xxxx-------shutter5 \n ");
			write_cmos_sensor(0x0342, 0x3F86);
			write_cmos_sensor(0x0340, 0xD4DC);
			write_cmos_sensor(0x0202, 0xD4CC); 		
		default:
	...
	LOG_INF("Exit! shutter =%d, framelength =%d,liyangaddshutter_choose=%d\n", shutter,imgsensor.frame_length,shutter_choose);
...
static unsigned char Sensor_Common_Reg_Init[]=
{
	...
	REG_INIT(0x6214, 0xFFFF),
	REG_INIT(0x6216, 0xFFFF),
	REG_INIT(0x6218, 0x0000),
	REG_INIT(0x621A, 0x0000),
	REG_INIT(0x6028, 0x2000),
	REG_INIT(0x602A, 0x2450),
	REG_INIT(0x6F12, 0x0448),
	REG_INIT(0x6F12, 0x0349),
	REG_INIT(0x6F12, 0x0160),
	REG_INIT(0x6F12, 0xC26A),
	REG_INIT(0x6F12, 0x511A),
	REG_INIT(0x6F12, 0x8180),
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x48B8),
	REG_INIT(0x6F12, 0x2000),
	REG_INIT(0x6F12, 0x2588),
	REG_INIT(0x6F12, 0x2000),
	...
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x5DF8),
	REG_INIT(0x6F12, 0x2748),
	REG_INIT(0x6F12, 0x4078),
	REG_INIT(0x6F12, 0x0028),
	REG_INIT(0x6F12, 0x0AD0),
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x5CF8),
	REG_INIT(0x6F12, 0x2549),
	REG_INIT(0x6F12, 0xB1F8),
	REG_INIT(0x6F12, 0x1403),
	REG_INIT(0x6F12, 0x4200),
	REG_INIT(0x6F12, 0x2448),
	REG_INIT(0x6F12, 0x4282),
	REG_INIT(0x6F12, 0x91F8),
	REG_INIT(0x6F12, 0x9610),
	REG_INIT(0x6F12, 0x4187),
	REG_INIT(0x6F12, 0x10BD),
	REG_INIT(0x6F12, 0x70B5),
	REG_INIT(0x6F12, 0x0446),
	REG_INIT(0x6F12, 0x2148),
	...
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x4CF8),
	REG_INIT(0x6F12, 0x2046),
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x4EF8),
	REG_INIT(0x6F12, 0x14F8),
	REG_INIT(0x6F12, 0x680F),
	REG_INIT(0x6F12, 0x6178),
	REG_INIT(0x6F12, 0x40EA),
	REG_INIT(0x6F12, 0x4100),
	REG_INIT(0x6F12, 0x1749),
	REG_INIT(0x6F12, 0xC886),
	REG_INIT(0x6F12, 0x1848),
	REG_INIT(0x6F12, 0x2278),
	REG_INIT(0x6F12, 0x007C),
	REG_INIT(0x6F12, 0x4240),
	REG_INIT(0x6F12, 0x1348),
	REG_INIT(0x6F12, 0xA230),
	REG_INIT(0x6F12, 0x8378),
	REG_INIT(0x6F12, 0x43EA),
	REG_INIT(0x6F12, 0xC202),
	REG_INIT(0x6F12, 0x0378),
	REG_INIT(0x6F12, 0x4078),
	REG_INIT(0x6F12, 0x9B00),
	REG_INIT(0x6F12, 0x43EA),
	REG_INIT(0x6F12, 0x4000),
	REG_INIT(0x6F12, 0x0243),
	REG_INIT(0x6F12, 0xD0B2),
	REG_INIT(0x6F12, 0x0882),
	REG_INIT(0x6F12, 0x3146),
	REG_INIT(0x6F12, 0x2846),
	...
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x2AB8),
	REG_INIT(0x6F12, 0x10B5),
	REG_INIT(0x6F12, 0x0022),
	REG_INIT(0x6F12, 0xAFF2),
	REG_INIT(0x6F12, 0x8701),
	REG_INIT(0x6F12, 0x0B48),
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x2DF8),
	REG_INIT(0x6F12, 0x084C),
	REG_INIT(0x6F12, 0x0022),
	REG_INIT(0x6F12, 0xAFF2),
	REG_INIT(0x6F12, 0x6D01),
	REG_INIT(0x6F12, 0x2060),
	REG_INIT(0x6F12, 0x0848),
	REG_INIT(0x6F12, 0x00F0),
	REG_INIT(0x6F12, 0x25F8),
	REG_INIT(0x6F12, 0x6060),
	REG_INIT(0x6F12, 0x10BD),
	REG_INIT(0x6F12, 0x0000),
	REG_INIT(0x6F12, 0x2000),
	REG_INIT(0x6F12, 0x0550),
	REG_INIT(0x6F12, 0x2000),
	REG_INIT(0x6F12, 0x0C60),
	REG_INIT(0x6F12, 0x4000),
	REG_INIT(0x6F12, 0xD000),
	REG_INIT(0x6F12, 0x2000),
	REG_INIT(0x6F12, 0x2580),
	REG_INIT(0x6F12, 0x2000),
	REG_INIT(0x6F12, 0x16F0),
	REG_INIT(0x6F12, 0x0000),
	REG_INIT(0x6F12, 0x2221),
	REG_INIT(0x6F12, 0x0000),
	REG_INIT(0x6F12, 0x2249),
	REG_INIT(0x6F12, 0x42F2),
	REG_INIT(0x6F12, 0x351C),
	REG_INIT(0x6F12, 0xC0F2),
	REG_INIT(0x6F12, 0x000C),
	REG_INIT(0x6F12, 0x6047),
	REG_INIT(0x6F12, 0x42F2),
	REG_INIT(0x6F12, 0xE11C),
	REG_INIT(0x6F12, 0xC0F2),
	REG_INIT(0x6F12, 0x000C),
	REG_INIT(0x6F12, 0x6047),
	REG_INIT(0x6F12, 0x40F2),
	REG_INIT(0x6F12, 0x077C),
	REG_INIT(0x6F12, 0xC0F2),
	REG_INIT(0x6F12, 0x000C),
	REG_INIT(0x6F12, 0x6047),
	REG_INIT(0x6F12, 0x42F2),
	REG_INIT(0x6F12, 0x492C),
	REG_INIT(0x6F12, 0xC0F2),
	REG_INIT(0x6F12, 0x000C),
	REG_INIT(0x6F12, 0x6047),
	REG_INIT(0x6F12, 0x4BF2),
	REG_INIT(0x6F12, 0x453C),
	REG_INIT(0x6F12, 0xC0F2),
	REG_INIT(0x6F12, 0x000C),
	REG_INIT(0x6F12, 0x6047),
	REG_INIT(0x6F12, 0x0000),
	...
	REG_INIT(0x6F12, 0x0000),
	REG_INIT(0x6F12, 0x0000),
	REG_INIT(0x6F12, 0x30C8),
	REG_INIT(0x6F12, 0x0157),
	REG_INIT(0x6F12, 0x0000),
	REG_INIT(0x6F12, 0x0003),
	REG_INIT(0x6028, 0x2000),
	REG_INIT(0x602A, 0x1082),
	REG_INIT(0x6F12, 0x8010),
	REG_INIT(0x6028, 0x4000),
	REG_INIT(0x31CE, 0x0001),
	REG_INIT(0x0200, 0x00C6),
	REG_INIT(0x3734, 0x0010),
	REG_INIT(0x3736, 0x0001),
	REG_INIT(0x3738, 0x0001),
	REG_INIT(0x37CC, 0x0000),
	REG_INIT(0x3744, 0x0100),
	REG_INIT(0x3762, 0x0105),
	REG_INIT(0x3764, 0x0105),
	REG_INIT(0x376A, 0x00F0),
	REG_INIT(0x344A, 0x000F),
	REG_INIT(0x344C, 0x003D),
	REG_INIT(0xF460, 0x0030),
	REG_INIT(0xF414, 0x24C2),
	REG_INIT(0xF416, 0x0183),
	REG_INIT(0xF468, 0x4005),
	REG_INIT(0x3424, 0x0A07),
	REG_INIT(0x3426, 0x0F07),
	REG_INIT(0x3428, 0x0F07),
	REG_INIT(0x341E, 0x0804),
	REG_INIT(0x3420, 0x0C0C),
	REG_INIT(0x3422, 0x2D2D),
	REG_INIT(0xF462, 0x003A),
	REG_INIT(0x3450, 0x0010),
	REG_INIT(0x3452, 0x0010),
	REG_INIT(0xF446, 0x0020),
	REG_INIT(0xF44E, 0x000C),
	REG_INIT(0x31FA, 0x0007),
	REG_INIT(0x31FC, 0x0161),
	REG_INIT(0x31FE, 0x0009),
	REG_INIT(0x3200, 0x000C),
	REG_INIT(0x3202, 0x007F),
	REG_INIT(0x3204, 0x00A2),
	REG_INIT(0x3206, 0x007D),
	REG_INIT(0x3208, 0x00A4),
	REG_INIT(0x3334, 0x00A7),
	REG_INIT(0x3336, 0x00A5),
	REG_INIT(0x3338, 0x0033),
	REG_INIT(0x333A, 0x0006),
	REG_INIT(0x333C, 0x009F),
	REG_INIT(0x333E, 0x008C),
	REG_INIT(0x3340, 0x002D),
	REG_INIT(0x3342, 0x000A),
	REG_INIT(0x3344, 0x002F),
	REG_INIT(0x3346, 0x0008),
	REG_INIT(0x3348, 0x009F),
	REG_INIT(0x334A, 0x008C),
	REG_INIT(0x334C, 0x002D),
	REG_INIT(0x334E, 0x000A),
	REG_INIT(0x3350, 0x000A),
	REG_INIT(0x320A, 0x007B),
	REG_INIT(0x320C, 0x0161),
	REG_INIT(0x320E, 0x007F),
	REG_INIT(0x3210, 0x015F),
	REG_INIT(0x3212, 0x007B),
	REG_INIT(0x3214, 0x00B0),
	REG_INIT(0x3216, 0x0009),
	REG_INIT(0x3218, 0x0038),
	REG_INIT(0x321A, 0x0009),
	REG_INIT(0x321C, 0x0031),
	REG_INIT(0x321E, 0x0009),
	REG_INIT(0x3220, 0x0038),
	REG_INIT(0x3222, 0x0009),
	REG_INIT(0x3224, 0x007B),
	REG_INIT(0x3226, 0x0001),
	REG_INIT(0x3228, 0x0010),
	REG_INIT(0x322A, 0x00A2),
	REG_INIT(0x322C, 0x00B1),
	REG_INIT(0x322E, 0x0002),
	REG_INIT(0x3230, 0x015D),
	REG_INIT(0x3232, 0x0001),
	REG_INIT(0x3234, 0x015D),
	REG_INIT(0x3236, 0x0001),
	REG_INIT(0x3238, 0x000B),
	REG_INIT(0x323A, 0x0016),
	REG_INIT(0x323C, 0x000D),
	REG_INIT(0x323E, 0x001C),
	REG_INIT(0x3240, 0x000D),
	REG_INIT(0x3242, 0x0054),
	REG_INIT(0x3244, 0x007B),
	REG_INIT(0x3246, 0x00CC),
	REG_INIT(0x3248, 0x015D),
	REG_INIT(0x324A, 0x007E),
	REG_INIT(0x324C, 0x0095),
	REG_INIT(0x324E, 0x0085),
	REG_INIT(0x3250, 0x009D),
	REG_INIT(0x3252, 0x008D),
	REG_INIT(0x3254, 0x009D),
	REG_INIT(0x3256, 0x007E),
	REG_INIT(0x3258, 0x0080),
	REG_INIT(0x325A, 0x0001),
	REG_INIT(0x325C, 0x0005),
	REG_INIT(0x325E, 0x0085),
	REG_INIT(0x3260, 0x009D),
	REG_INIT(0x3262, 0x0001),
	REG_INIT(0x3264, 0x0005),
	REG_INIT(0x3266, 0x007E),
	REG_INIT(0x3268, 0x0080),
	REG_INIT(0x326A, 0x0053),
	REG_INIT(0x326C, 0x007D),
	REG_INIT(0x326E, 0x00CB),
	REG_INIT(0x3270, 0x015E),
	REG_INIT(0x3272, 0x0001),
	REG_INIT(0x3274, 0x0005),
	REG_INIT(0x3276, 0x0009),
	REG_INIT(0x3278, 0x000C),
	REG_INIT(0x327A, 0x007E),
	REG_INIT(0x327C, 0x0098),
	REG_INIT(0x327E, 0x0009),
	REG_INIT(0x3280, 0x000C),
	REG_INIT(0x3282, 0x007E),
	REG_INIT(0x3284, 0x0080),
	REG_INIT(0x3286, 0x0044),
	REG_INIT(0x3288, 0x0163),
	REG_INIT(0x328A, 0x0045),
	REG_INIT(0x328C, 0x0047),
	REG_INIT(0x328E, 0x007D),
	REG_INIT(0x3290, 0x0080),
	REG_INIT(0x3292, 0x015F),
	REG_INIT(0x3294, 0x0162),
	REG_INIT(0x3296, 0x007D),
	REG_INIT(0x3298, 0x0000),
	REG_INIT(0x329A, 0x0000),
	REG_INIT(0x329C, 0x0000),
	REG_INIT(0x329E, 0x0000),
	REG_INIT(0x32A0, 0x0008),
	REG_INIT(0x32A2, 0x0010),
	REG_INIT(0x32A4, 0x0018),
	REG_INIT(0x32A6, 0x0020),
	REG_INIT(0x32A8, 0x0000),
	REG_INIT(0x32AA, 0x0008),
	REG_INIT(0x32AC, 0x0010),
	REG_INIT(0x32AE, 0x0018),
	REG_INIT(0x32B0, 0x0020),
	REG_INIT(0x32B2, 0x0020),
	REG_INIT(0x32B4, 0x0020),
	REG_INIT(0x32B6, 0x0020),
	REG_INIT(0x32B8, 0x0000),
	REG_INIT(0x32BA, 0x0000),
	REG_INIT(0x32BC, 0x0000),
	REG_INIT(0x32BE, 0x0000),
	REG_INIT(0x32C0, 0x0000),
	REG_INIT(0x32C2, 0x0000),
	REG_INIT(0x32C4, 0x0000),
	REG_INIT(0x32C6, 0x0000),
	REG_INIT(0x32C8, 0x0000),
	REG_INIT(0x32CA, 0x0000),
	REG_INIT(0x32CC, 0x0000),
	REG_INIT(0x32CE, 0x0000),
	REG_INIT(0x32D0, 0x0000),
	REG_INIT(0x32D2, 0x0000),
	REG_INIT(0x32D4, 0x0000),
	REG_INIT(0x32D6, 0x0000),
	REG_INIT(0x32D8, 0x0000),
	REG_INIT(0x32DA, 0x0000),
	REG_INIT(0x32DC, 0x0000),
	REG_INIT(0x32DE, 0x0000),
	REG_INIT(0x32E0, 0x0000),
	REG_INIT(0x32E2, 0x0000),
	REG_INIT(0x32E4, 0x0000),
	REG_INIT(0x32E6, 0x0000),
	REG_INIT(0x32E8, 0x0000),
	REG_INIT(0x32EA, 0x0000),
	REG_INIT(0x32EC, 0x0000),
	REG_INIT(0x32EE, 0x0000),
	REG_INIT(0x32F0, 0x0000),
	REG_INIT(0x32F2, 0x0000),
	REG_INIT(0x32F4, 0x000A),
	REG_INIT(0x32F6, 0x0002),
	REG_INIT(0x32F8, 0x0008),
	REG_INIT(0x32FA, 0x0010),
	REG_INIT(0x32FC, 0x0020),
	REG_INIT(0x32FE, 0x0028),
	REG_INIT(0x3300, 0x0038),
	REG_INIT(0x3302, 0x0040),
	REG_INIT(0x3304, 0x0050),
	REG_INIT(0x3306, 0x0058),
	REG_INIT(0x3308, 0x0068),
	REG_INIT(0x330A, 0x0070),
	REG_INIT(0x330C, 0x0080),
	REG_INIT(0x330E, 0x0088),
	REG_INIT(0x3310, 0x0098),
	REG_INIT(0x3312, 0x00A0),
	REG_INIT(0x3314, 0x00B0),
	REG_INIT(0x3316, 0x00B8),
	REG_INIT(0x3318, 0x00C8),
	REG_INIT(0x331A, 0x00D0),
	REG_INIT(0x331C, 0x00E0),
	REG_INIT(0x331E, 0x00E8),
	REG_INIT(0x3320, 0x0017),
	REG_INIT(0x3322, 0x002F),
	REG_INIT(0x3324, 0x0047),
	REG_INIT(0x3326, 0x005F),
	REG_INIT(0x3328, 0x0077),
	REG_INIT(0x332A, 0x008F),
	REG_INIT(0x332C, 0x00A7),
	REG_INIT(0x332E, 0x00BF),
	REG_INIT(0x3330, 0x00D7),
	REG_INIT(0x3332, 0x00EF),
	REG_INIT(0x3352, 0x00A5),
	REG_INIT(0x3354, 0x00AF),
	REG_INIT(0x3356, 0x0187),
	REG_INIT(0x3358, 0x0000),
	REG_INIT(0x335A, 0x009E),
	REG_INIT(0x335C, 0x016B),
	REG_INIT(0x335E, 0x0015),
	REG_INIT(0x3360, 0x00A5),
	REG_INIT(0x3362, 0x00AF),
	REG_INIT(0x3364, 0x01FB),
	REG_INIT(0x3366, 0x0000),
	REG_INIT(0x3368, 0x009E),
	REG_INIT(0x336A, 0x016B),
	REG_INIT(0x336C, 0x0015),
	REG_INIT(0x336E, 0x00A5),
	REG_INIT(0x3370, 0x00A6),
	REG_INIT(0x3372, 0x0187),
	REG_INIT(0x3374, 0x0000),
	REG_INIT(0x3376, 0x009E),
	REG_INIT(0x3378, 0x016B),
	REG_INIT(0x337A, 0x0015),
	REG_INIT(0x337C, 0x00A5),
	REG_INIT(0x337E, 0x00A6),
	REG_INIT(0x3380, 0x01FB),
	REG_INIT(0x3382, 0x0000),
	REG_INIT(0x3384, 0x009E),
	REG_INIT(0x3386, 0x016B),
	REG_INIT(0x3388, 0x0015),
	REG_INIT(0x319A, 0x0005),
	REG_INIT(0x1006, 0x0005),
	REG_INIT(0x3416, 0x0001),
	REG_INIT(0x308C, 0x0008),
	REG_INIT(0x307C, 0x0240),
	REG_INIT(0x375E, 0x0050),
	REG_INIT(0x31CE, 0x0101),
	REG_INIT(0x374E, 0x0007),
	REG_INIT(0x3460, 0x0001),
	REG_INIT(0x3052, 0x0002),
	REG_INIT(0x3058, 0x0001),
	REG_INIT(0x6028, 0x2000),
	REG_INIT(0x602A, 0x108A),
	REG_INIT(0x6F12, 0x0359),
	REG_INIT(0x6F12, 0x0100),	
	REG_INIT(0x6028, 0x4000),
	REG_INIT(0x1124, 0x4100),
	REG_INIT(0x1126, 0x0000),
	REG_INIT(0x112C, 0x4100),
	REG_INIT(0x112E, 0x0000),
	REG_INIT(0x3442, 0x0100),
};
#endif
...
#else
    LOG_INF("sizeof(Sensor_Common_Reg_Init)=%lud\n",sizeof(Sensor_Common_Reg_Init));
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if((*sensor_id) == 0x30c8)	
		    {
			    s5k3l8b_selective_read_byte(0x0CEB,&module,0xA0 );
		    }
            if ((*sensor_id == imgsensor_info.sensor_id)&&(module == 255)) {
			LOG_INF("i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);
			//app_get_back_sensor_name("s5k3l8b_ofilm");
			*sensor_id = 0x30c9;
			LOG_INF("i2c write id2: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);
			return ERROR_NONE;
            }
  ...
  //  unsigned long long *feature_return_para=(unsigned long long *) feature_para;
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			S5K3L8B_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;	
        /******************** PDAF END   <<< *********/
...
UINT32 S5K3L8B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
