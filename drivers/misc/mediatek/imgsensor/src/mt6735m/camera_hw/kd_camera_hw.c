		       ...
		       char *mode_name)
{
	...
	if (On) 
	{
		...
		PK_DBG("[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
              if(currSensorName && ((0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3H7YX_MIPI_RAW))||(0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3L8_MIPI_RAW))||(0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3L8B_MIPI_RAW))))
		{
