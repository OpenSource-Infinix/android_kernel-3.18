...
bool s5k3l8_selective_read_byte(unsigned short addr,unsigned char *data,u16 i2c_id )
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if((*sensor_id) == 0x30c8)	
		    {
			    s5k3l8_selective_read_byte(0x0CEB,&module,0xA0 );
		    }
            if ((*sensor_id == imgsensor_info.sensor_id)&&(module == 1)) {
