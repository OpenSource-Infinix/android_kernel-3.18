/*
 * DW9800BAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9800BAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DW9800BAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
	//LOG_INF("DW9800BAF_Ioctl\n");
	switch (a_u4Command) {
...
int DW9800BAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void DW9800BAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#if 0
static ssize_t dw9800b_test_store(struct device *dev,
...
static ssize_t dw9800b_test_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
    	char *s;
	s=buf;
	s+=sprintf(s,"dw9800b_test_show)\n");
 	printk("dw9800b_test_show\n");

	return s-buf;
}

static DEVICE_ATTR(dw9800b_test, 0664, dw9800b_test_show, dw9800b_test_store); 


static int __init dw9800b_test_init(void)
{
static struct class *dw9800b_test_class = NULL;
static struct device *dw9800b_test_dev = NULL;
    dw9800b_test_class = class_create(THIS_MODULE, "DW9800b_test");

    if (IS_ERR(dw9800b_test_class)) {

	printk("[dw9800b_test_init] Unable to create class, err = %d\n", (int)PTR_ERR(dw9800b_test_class));
       return 0;
    }
    dw9800b_test_dev = device_create(dw9800b_test_class, NULL, 0, 0,"DW9800b_test");
    if(NULL == dw9800b_test_dev){

	  printk("[dw9800b_test_init] device_create fail\n");
       return 0;
    }

	device_create_file(dw9800b_test_dev, &dev_attr_dw9800b_test); 

    printk("[dw9800b_test_init] Done\n");
    return 0;
}

static void __exit dw9800b_test_exit(void)
{
...
module_init(dw9800b_test_init);
module_exit(dw9800b_test_exit);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("xzk>");
MODULE_DESCRIPTION("DW9800b_test");
#endif